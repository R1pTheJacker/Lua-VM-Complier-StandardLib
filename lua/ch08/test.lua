-- local function max(...) --test vararg
--     local args = {...}
--     local val, idx
--     for i = 1, #args do
...
-- local v2, i2 = max(3, 9, 7, 128, 35) --test multiple return values
-- assert(v2 == 128 and i2 == 4)

-- local v3, i3 = max(max(3, 9, 7, 128, 35)) --test recursion
-- assert(v3 == 128 and i2 == 1)
