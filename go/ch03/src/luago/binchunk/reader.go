...
//read type cint by litte-endian from byte stream
...
//read type size_t by litte-endian from byte stream
...
//read Lua int from byte stream
func (self *reader) readLuaInteger() int64 {
	return int64(self.readUint64())
}

//read Lua floating point from byte stream
func (self *reader) readLuaNumber() float64 {
	return math.Float64frombits(self.readUint64())
}

//read Lua string from byte stream
...
//check the correctness of binary chunk header
...
//read function prototype from byte stream
...
//read instruction table from byte stream
...
//read constant table from byte stream
...
//read a constant from byte stream
...
//read upvalue table from byte stream
...
//read prototype function table from byte stream
...
//read line table from byte stream
...
//read local variable table from byte stream
...
//read upvalue names from byte stream
